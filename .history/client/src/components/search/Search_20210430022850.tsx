...
const Search: FC = () => {
	...
	const updateSuggestions = useCallback(async () => {
		console.log(localSearch.value.length)
		if (localSearch.value.length > 0) {
			...
			console.log('file: Search.tsx ~ line 24 ~ suggestions.data', suggestions.data)
		} else {
			const suggestions: any = await getSuggestions(localSearch.mode)

			setSearchSuggestions(suggestions.data)
			console.log('file: Search.tsx ~ line 29 ~ suggestions.data', suggestions.data)
		}
	}, [localSearch])
