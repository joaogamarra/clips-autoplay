...
import './sidebar.scss'
import { HeartFillIcon, XCircleFillIcon, HomeFillIcon, ArchiveIcon } from '@primer/octicons-react'
			...
			{favourites && (
				<aside className={`favourites-bar ${favouritesVisible === true ? 'is-visible' : ''}`}>
					<div className='favourites-container'>
						...
						<button className='title-lg'>
							<Link to='/feedback' title='Feedback' onClick={handleFavouriteClick}>
								<ArchiveIcon size={30} className='sidebar-icon' />
