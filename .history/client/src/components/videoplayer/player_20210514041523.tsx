			...
			<div className='player-container'>
				...
				{error && (
					<p>
						...
						<br />
						The game/user might not exist or they might not have any clips in the selected period. Users that
						are currently suspended also have their clips disabled.
					</p>
				)}
