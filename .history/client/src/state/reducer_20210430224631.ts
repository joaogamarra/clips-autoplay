import { State, Action, ClipType, ClipsResponseType } from 'src/types/state'
import { searchClips } from 'src/types/search'

export const setClips = (clips: ClipsResponseType): Action => {
	return {
		type: 'SET_CLIPS',
		payload: clips,
	}
...
export const setCurrentClip = (clip: ClipType): Action => {
	return {
...
export const updateClips = (clips: ClipsResponseType): Action => {
	return {
		type: 'UPDATE_CLIPS',
		payload: clips,
	}
